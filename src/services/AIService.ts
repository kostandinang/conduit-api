...
export class AIService {
	 ...
	 */
	async generateReply(leadId: string, channel: MessageChannel, context?: string): Promise<string> {
	 ...
	 */
	private async generateWithOpenAI(conversationHistory: any[], context?: string): Promise<string> {
